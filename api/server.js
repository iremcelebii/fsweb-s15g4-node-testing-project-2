...
const favsRouter = require("./favs/favs-router.js");
...
server.use("/api/favs", authMd.tokenKontrolu, favsRouter);
server.use("/api/comments", authMd.tokenKontrolu, commentsRouter);
